...
pub const SNAKE_TEXT_H_ = "";
pub const MULTIPLAYER_LOCAL = @as(c_int, 13);
pub const MULTIPLAYER_LAN = @as(c_int, 14);
pub const LAN_HOSTGAME = @as(c_int, 15);
pub const LAN_JOINGAME = @as(c_int, 16);
